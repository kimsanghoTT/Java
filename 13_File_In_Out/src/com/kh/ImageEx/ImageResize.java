...
/*
	BufferedImage
	- 이미지 데이터를 저장하고 처리하는 데 사용
	
	
	Image
	- 인터페이스. 이미지를 표현하는 추상화된 개념을 제공
	
	
	ImageIO
	- 이미지를 파일로부터 읽고 출력하는 이미지 In Out
...
public class ImageResize {
	...
	public static void main(String[] args) {
		...
		String 수정이미지 = "src/com/kh/ImageEx/marley_cute.jpg";
		
		//이미지 가로 세로 크기 설정
		int 가로크기 = 200;
		int 세로크기 = 200;
		
		//BufferedImage를 통해 이미지 가져오기
		...
		try {
			...
			//새로운 크기의 이미지 생성							가로길이  세로길이  이미지 색상
			...
			//새로 만든 이미지를 파일로 저장하기
			ImageIO.write(크기조정이미지, "jpg", new File(수정이미지));
