...
public class ServerEx {
	...
	private static final int SERVER_PORT = 12377;
	...
	public static void main(String[] args) throws Exception {
		...
		//주최자가 방문자에게 메시지를 담아 보낼 수 있는 그릇 생성
